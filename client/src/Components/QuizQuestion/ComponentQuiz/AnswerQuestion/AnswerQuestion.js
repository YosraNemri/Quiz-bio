...
import MoreInformation from "../MoreinformationC/Moreinfo";
const AnswerQuestion = ({
    ...
    /**** calculate final points of Component quiz */
    const newComponentScore = info.componentPoints + score;
    ...
    const handleNext = () => {
        ...
        if (nextQuestions < questions.length) {
            ...
            setUser({
                ...
                componentPoints: newComponentScore,
            });
